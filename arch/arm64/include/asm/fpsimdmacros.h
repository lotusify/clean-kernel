...
// Simplified for Clang compatibility
.macro fpsimd_save_partial state, numnr, tmpnr1, tmpnr2
	// Simple fallback - save all registers (not partial)
	fpsimd_save \state, \tmpnr1
.endm

.macro fpsimd_restore_partial state, tmpnr1, tmpnr2
	// Simple fallback - restore all registers (not partial)
	fpsimd_restore \state, \tmpnr1
.endm
